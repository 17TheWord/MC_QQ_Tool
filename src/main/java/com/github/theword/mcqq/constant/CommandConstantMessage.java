...
public class CommandConstantMessage {
    ...
    public static final String RELOAD_CLOSE_WEBSOCKET_CLIENT = "正在关闭连接至：%s 的 Websocket Client";
    public static final String RELOAD_CLEAR_WEBSOCKET_CLIENT_LIST = "旧连接清理完毕";
    public static final String RELOADED = "重载完成";
    ...
    public static final String RECONNECTED = "重连完成";
}
